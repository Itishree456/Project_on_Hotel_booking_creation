...
public class Post_TC_6 {
	...
	public static void execute() throws IOException 
	{
		...
		for (int i = 0; i < 5; i++) 
		{
			...
			String requestbody = Post_req_repository2.Post_TC6();
			...
			{	
				...
				Post_TC_6.validator(responseBody, statusCode);
				Utility_Common_Function.Evidence_File_Creator("Post_TC_6", Post_req_repository2.Post_Resource(), responseBody);
				break;
			} 
			else 
			{
	...
	public static void validator(String responseBody, int statusCode) throws IOException {
		...
		JsonPath jspreq = new JsonPath(Post_req_repository2.Post_TC6());
